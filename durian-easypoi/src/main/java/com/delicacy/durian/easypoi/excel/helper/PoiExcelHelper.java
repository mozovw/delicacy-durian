...
public abstract class PoiExcelHelper {
	...
	public abstract ArrayList<String> getSheetList(InputStream input);
	...
	public abstract ArrayList<ArrayList<String>> readExcel(InputStream input, int sheetIndex, String rows, String columns);
	...
	public abstract ArrayList<ArrayList<String>> readExcel(InputStream input, int sheetIndex, String rows, int[] cols);
